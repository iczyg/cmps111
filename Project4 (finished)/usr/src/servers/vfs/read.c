 ...
 *				do_read_m					             					 *
 *===========================================================================*/
PUBLIC int do_read_m()
{
  return(read_write_m(READING));
}
...
/*===========================================================================*
 *				read_write_m		-based off of read_write			     *
 *===========================================================================*/
PUBLIC int read_write_m(rw_flag)
int rw_flag;			/* READING or WRITING */
{
	register struct filp *f;
	register struct vnode *vp;
	...
	/* Issue request */
	r = req_read_write_m(vp->v_fs_e, vp->v_inode_nr, rw_flag, who_e,
